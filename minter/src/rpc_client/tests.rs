...
mod multi_rpc_results {
    use evm_rpc_client::{
        types::candid::{
            Block as EvmBlock, BlockTag as EvmBlockTag, EthSepoliaService,
            ...
            HttpOutcallError, LogEntry as EvmLogEntry, MultiRpcResult as EvmMultiRpcResult,
    ...
    mod reduce_with_stable_majority_by_key {
        ...
        use crate::{
            ...
            rpc_client::{MultiCallError, Reduce, ReducedResult},
